		...
		<div class="top flex flex-wrap w-full">
			<div class="grid grid-cols-1 md:grid-cols-3 gap-1">
				<div class="flex flex-wrap">
					<h3 class="text-2xl text-gray-50 font-medium w-full">
						<a href="{{ url('/') }}">
						<img style="background-color: #e3a008;border-radius: 5%;padding: 1px 4px;" src="{{ url('logo.png') }}" alt="{{ \SiteInfo::name() }} logo">
						</a>
					</h3>
